...
`;k.div``;const Kg=()=>{const[e,t]=R.exports.useState(!1),[n,r]=R.exports.useState({address:""}),[i,o]=R.exports.useState({address:""}),[l,a]=R.exports.useState("giving"),s=p=>{a(p),t(!0)},u=p=>{if(t(!1),l=="getting"){const m=h(p);o(m)}if(l=="giving"){const m=h(p);r(m)}},h=p=>Xn.find(m=>m.address===p);return P(si,{children:[P(Qg,{children:[c(Gg,{children:c(j,{uppercase:!0,weight:"700",size:"16px",children:"List"})}),P(Yg,{children:[P(Oc,{children:[c("label",{htmlFor:"",children:"You give"}),P(Ac,{children:[c(Ic,{type:"number",step:.1}),c("div",{children:c(Eo,{token:n||Xn[4],hasCaret:!0,handleClick:()=>s("giving")})})]})]}),c(J,{height:31}),c(fg,{style:{textAlign:"center"},height:10,width:10,children:c(Zs,{})}),c(J,{height:6}),P(Oc,{children:[c("label",{htmlFor:"",children:"You get"}),P(Ac,{children:[c(Ic,{type:"number",step:.1}),c("div",{children:c(Eo,{token:i||Xn[2],hasCaret:!0,handleClick:()=>s("getting")})})]})]}),c(J,{height:30}),c(ve,{className:"primary block m-sm",children:"Continue"})]})]}),c(bg,{handleSelected:p=>u(p),show:e,handleClose:()=>t(!1)})]})},Xg=k.div`
  background: #ffffff;
